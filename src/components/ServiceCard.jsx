      ...
      <div className="p-5 flex flex-col flex-1">
        <div className="flex items-center gap-2.5 mb-2">
          <span className="text-brand shrink-0">
            {serviceIcons[service.icon] || serviceIcons["ac-repair"]}
          </span>
        ...
        <span className="mt-3 text-brand font-semibold text-sm inline-flex items-center gap-1 group-hover:gap-2 transition-all">
          Learn More
