...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#1B2A4A] text-white/70">
              ...
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <a
                    ...
                    className="text-sm text-white/50 transition-colors duration-300 hover:text-[#D4A843]"
                  >
                    {link.label}
                  </a>
                </li>
            ...
            <ul className="space-y-3 text-sm text-white/50">
              <li>
                <a
                  ...
                  className="transition-colors duration-300 hover:text-[#D4A843]"
                >
                  {config.phone}
                </a>
              </li>
