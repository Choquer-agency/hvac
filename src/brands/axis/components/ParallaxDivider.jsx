  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <div className="absolute inset-0 bg-[#010101]/70" />
      </motion.div>
      ...
      <div className="relative z-10 text-center px-6 max-w-4xl mx-auto">
        ...
        <motion.a
          ...
          className="inline-block px-10 py-4 bg-[#F2CF37] text-[#010101] font-bold text-sm uppercase tracking-wider rounded-full hover:bg-[#D4B52E] hover:scale-[1.03] active:scale-[0.98] transition-all duration-200"
          style={{ fontFamily: "'Space Grotesk', sans-serif" }}
        >
          Get a Quote
        </motion.a>
