...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#010101] border-t border-[#1a1a1a]">
      <div className="max-w-7xl mx-auto px-6 py-16 md:py-20">
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div>
            <h4
              className="text-xs font-bold uppercase tracking-[0.2em] text-[#F2CF37] mb-6"
              ...
              {config.services.slice(0, 6).map((service) => (
                <li key={service.slug}>
                  <a
                    ...
                    className="text-gray-400 text-sm hover:text-[#F2CF37] transition-colors"
                    style={{ fontFamily: "'DM Sans', sans-serif" }}
                  >
                    {service.name}
                  </a>
            ...
            >
              <li>
                <a
                  ...
                  className="hover:text-[#F2CF37] transition-colors"
                >
                  {config.phone}
                </a>
              </li>
