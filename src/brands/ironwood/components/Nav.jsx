      ...
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-4 lg:px-12">
        ...
        <div className="hidden items-center gap-10 md:flex">
          {navLinks.map((link) => (
            <a
              ...
              onMouseEnter={(e) => {
                e.target.style.color = scrolled ? "#3B4841" : "#FDF8F0";
              }}
              onMouseLeave={(e) => {
        ...
        >
          <motion.span
            animate={
              mobileOpen
                ? { rotate: 45, y: 7, background: "#3B4841" }
                : {
                    rotate: 0,
                    y: 0,
                    background: scrolled ? "#3B4841" : "#FDF8F0",
                  }
            }
      ...
      <AnimatePresence>
        {mobileOpen && (
          <motion.div
            ...
            className="fixed inset-0 z-40 flex flex-col items-start justify-center bg-[#FDF8F0] px-12 md:hidden"
          >
            {navLinks.map((link, i) => (
              <motion.a
                key={link.label}
                ...
                className="mb-8 text-3xl text-[#3B4841] transition-colors duration-300 hover:text-[#ED6442]"
                style={{
            ...
            <motion.a
              ...
              className="mt-4 flex items-center gap-3 text-lg tracking-wide text-[#ED6442]"
