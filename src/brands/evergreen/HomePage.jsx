...
function Word({ children, progress, range }) {
  ...
  const color = useTransform(progress, range, ["#19313326", "#193133"]);
...
function StatsBar() {
  return (
    <section className="relative z-10 bg-[#0F2022]">
  ...
  return (
    <section id="models" className="bg-white px-6 py-28 lg:px-12 lg:py-36">
      <div className="mx-auto max-w-7xl">
        <Reveal>
          <p className="mb-3 flex items-center gap-3 text-sm font-medium uppercase tracking-[0.2em] text-[#4CAF50]">
            <span className="inline-block h-[2px] w-8 bg-[#4CAF50]" />
            {config.modelsSection.eyebrow}
          </p>
        </Reveal>
        <Reveal delay={0.08}>
          <h2
            className="mb-16 text-[clamp(2rem,4vw,3rem)] font-bold leading-tight tracking-tight text-[#193133] whitespace-nowrap"
            style={{ fontFamily: "Outfit, sans-serif" }}
          >
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {config.models.map((model, i) => (
            <Reveal key={model.slug} delay={i * 0.1}>
              <div className="group relative overflow-hidden rounded-2xl border border-[#193133]/5 bg-white shadow-sm transition-all duration-500 hover:-translate-y-2 hover:shadow-2xl hover:shadow-black/10 h-full flex flex-col">
                {/* Image */}
                <div className="relative aspect-[4/3] overflow-hidden shrink-0">
                  ...
                  <div className="absolute inset-0 flex items-end bg-gradient-to-t from-[#193133]/90 via-[#193133]/40 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100">
                ...
                <div className="p-6 flex flex-col flex-1">
                  <h3
                    className="text-xl font-bold text-[#193133] mb-1"
                    style={{ fontFamily: "Outfit, sans-serif" }}
                  >
                    {model.name}
                  </h3>
                  ...
                  <p className="text-sm leading-relaxed text-[#2A4A4D] mb-5 line-clamp-3">
                    {model.description}
                  </p>
...
function MarqueeBand() {
  return (
    ...
    >
      <div className="bg-[#193133] py-5 lg:py-6">
          ...
          {[...Array(3)].map((_, setIdx) => (
            <div key={setIdx} className="flex shrink-0">
              {config.marqueeWords.map((word, i) => (
                ...
                >
                  {word}
                  <span className="ml-6 lg:ml-10 text-[#D0FF71]/50">&#9679;</span>
                </span>
              ))}
            </div>
          ))}
...
function ProcessSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="process"
      className="bg-[#193133] px-6 py-28 lg:px-12 lg:py-36"
    >
      <div className="mx-auto max-w-7xl">
        <Reveal>
          <p className="mb-3 flex items-center gap-3 text-sm font-medium uppercase tracking-[0.2em] text-[#D0FF71]">
            <span className="inline-block h-[2px] w-8 bg-[#D0FF71]" />
        ...
        <div className="relative">
          ...
          <motion.div
            className="absolute left-0 top-6 hidden h-[2px] bg-[#D0FF71] lg:block"
            ...
            {config.process.map((step, i) => (
              <Reveal key={step.step} delay={i * 0.12}>
                <div className="group relative flex gap-6 lg:flex-col lg:gap-4">
                  <div className="relative z-10 flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#D0FF71] text-[#193133] shadow-lg shadow-[#D0FF71]/20 transition-transform duration-300 group-hover:scale-110">
                    {stepIcons[i]}
                  </div>
                  <div>
                    <h3
...
function ParallaxDivider() {
  ...
  return (
    <section ref={sectionRef} className="relative grid lg:grid-cols-2 min-h-[50vh]">
      {/* Left — text */}
      <div className="flex items-center justify-center bg-[#193133] px-8 py-20 lg:px-16 lg:py-28">
        <Reveal>
          <div className="max-w-md">
            <p
              className="text-sm font-medium uppercase tracking-[0.2em] text-[#D0FF71] mb-4"
              style={{ fontFamily: "Outfit, sans-serif" }}
            >
              Shipped Nationwide
            </p>
            <p
              ...
              style={{ fontFamily: "Outfit, sans-serif" }}
            >
              Your home. Built in weeks,{" "}
              <span className="text-[#D0FF71]">not months.</span>
            </p>
            <p className="text-sm leading-relaxed text-white/50">
              From our factory floor to your foundation — precision-built, quality-assured, and ready to live in.
            </p>
          </div>
        </Reveal>
      </div>
...
function PackagesSection() {
  return (
    <section id="packages" className="bg-[#0F2022] px-6 py-28 lg:px-12 lg:py-36">
      <div className="mx-auto max-w-7xl">
        <Reveal>
          <p className="mb-3 flex items-center gap-3 text-sm font-medium uppercase tracking-[0.2em] text-[#D0FF71]">
            <span className="inline-block h-[2px] w-8 bg-[#D0FF71]" />
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {config.packages.map((pkg, i) => (
            <Reveal key={pkg.name} delay={i * 0.08}>
              <div className="group relative rounded-2xl border border-white/8 bg-white/[0.03] backdrop-blur-sm p-7 transition-all duration-500 hover:-translate-y-2 hover:bg-white/[0.06] hover:border-[#D0FF71]/20 h-full flex flex-col">
                {/* Icon */}
                <div className="mb-5 flex h-11 w-11 items-center justify-center rounded-xl bg-[#D0FF71]/10 text-[#D0FF71]">
                ...
                <p
                  ...
                  style={{ color: "#D0FF71", fontFamily: "Outfit, sans-serif" }}
                >
                  {pkg.price}
                </p>
                ...
                <ul className="space-y-2.5 mt-auto">
                  {pkg.features.map((f) => (
                    <li key={f} className="flex items-start gap-2.5 text-sm text-white/60">
                      <svg
                        className="w-4 h-4 mt-0.5 shrink-0 text-[#D0FF71]/70"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                      >
                        <path
  ...
  return (
    <section className="bg-white px-6 py-28 lg:px-12 lg:py-36">
      <div className="mx-auto max-w-7xl">
        ...
        <Reveal delay={0.08}>
          <h2
            className="mb-16 max-w-xl text-[clamp(2rem,4vw,3rem)] font-bold leading-tight tracking-tight text-[#193133]"
            style={{ fontFamily: "Outfit, sans-serif" }}
          >
            See what&apos;s possible
          </h2>
            ...
            >
              <div className="group relative overflow-hidden rounded-xl h-full">
                <img
                  ...
                  loading="lazy"
                />
                <div className="absolute inset-0 bg-[#193133]/0 transition-colors duration-500 group-hover:bg-[#193133]/30" />
...
function ReviewsSection() {
  return (
    <section id="reviews" className="bg-[#193133] px-6 py-28 lg:px-12 lg:py-36">
      <div className="mx-auto max-w-7xl">
        <Reveal>
          <p className="mb-3 flex items-center gap-3 text-sm font-medium uppercase tracking-[0.2em] text-[#D0FF71]">
            <span className="inline-block h-[2px] w-8 bg-[#D0FF71]" />
              ...
              <div className="group relative rounded-2xl border border-white/8 bg-white/[0.03] p-8 lg:p-10 transition-all duration-500 hover:bg-white/[0.06] hover:border-white/15 h-full flex flex-col">
                ...
                <div className="flex gap-1 mb-5">
                  {Array.from({ length: review.rating }, (_, j) => (
                    <svg key={j} className="h-4 w-4 text-[#D0FF71]" fill="currentColor" viewBox="0 0 20 20">
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        <Reveal>
          <p
            ...
            style={{ color: "#4CAF50", fontFamily: "Outfit, sans-serif" }}
          >
        ...
        <Reveal delay={0.08}>
          <h2
            className="mb-6 text-[clamp(2rem,5vw,3.5rem)] font-bold leading-tight tracking-tight text-[#193133]"
            style={{ fontFamily: "Outfit, sans-serif" }}
          >
        ...
        <Reveal delay={0.16}>
          <p className="mx-auto mb-10 max-w-lg text-lg leading-relaxed text-[#2A4A4D]">
        ...
        <Reveal delay={0.24}>
          <a
            ...
            className="group inline-flex items-center gap-2 rounded-full px-10 py-4 text-sm font-bold transition-all duration-300 hover:-translate-y-0.5 hover:shadow-xl hover:shadow-[#193133]/15"
            style={{
              fontFamily: "Outfit, sans-serif",
...
export default function HomePage() {
  useBrandMeta("evergreen", config.companyName);
  return (
    <div data-brand="evergreen" className="min-h-screen bg-white">
      <Nav />
      <Hero />
      <StatsBar />
      <AboutStatement />
