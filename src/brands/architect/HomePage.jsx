...
function AboutStatement() {
  ...
  return (
    <section
      ref={containerRef}
      id="about"
      className="relative bg-[#FAF7F2] px-6 py-32 lg:px-12 lg:py-44"
    >
...
function Word({ children, progress, range }) {
  ...
  const color = useTransform(progress, range, ["#3D3E3D26", "#1a1a1a"]);
...
function FeaturedProject() {
  ...
  return (
    <section
      ref={sectionRef}
      id="featured"
      className="relative overflow-hidden bg-[#1a1a1a] px-6 py-28 lg:px-12 lg:py-36"
    >
      <div className="mx-auto max-w-7xl">
        <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-20">
          ...
          <div>
            <Reveal>
              <p className="mb-3 flex items-center gap-3 text-sm font-medium uppercase tracking-[0.2em] text-[#F89525]">
                <span className="inline-block h-[2px] w-8 bg-[#F89525]" />
            ...
            <Reveal delay={0.32}>
              <a
                href="#contact"
                className="group inline-flex items-center gap-2 rounded-full bg-[#F89525] px-8 py-3.5 text-sm font-semibold text-white transition-all duration-300 hover:shadow-xl hover:shadow-[#F89525]/20 hover:-translate-y-0.5"
                style={{ fontFamily: "'Rethink Sans', sans-serif" }}
              >
                Start Your Project
...
function ServicesSection() {
  return (
    <section id="services" className="bg-[#FAF7F2] px-6 py-28 lg:px-12 lg:py-36">
      <div className="mx-auto max-w-7xl">
        {/* Header */}
        <Reveal>
          <p className="mb-3 flex items-center gap-3 text-sm font-medium uppercase tracking-[0.2em] text-[#F89525]">
        ...
        <Reveal delay={0.08}>
          <h2
            className="mb-16 max-w-xl text-[clamp(2rem,4vw,3rem)] font-bold leading-tight tracking-tight text-[#1a1a1a]"
            style={{ fontFamily: "'Rethink Sans', sans-serif" }}
          >
            ...
            <Reveal key={service.title} delay={i * 0.08}>
              <div className="group relative aspect-[4/3] overflow-hidden rounded-xl cursor-pointer transition-shadow duration-500 hover:shadow-2xl hover:shadow-black/10">
                ...
                <div className="absolute inset-x-0 bottom-0 p-6 transition-transform duration-500 ease-out">
                  {/* Category line */}
                  <div className="mb-3 h-[2px] w-0 bg-[#F89525] transition-all duration-500 ease-out group-hover:w-10" />
                  <h3
                  ...
                  <div className="mt-3 flex items-center gap-2 text-sm font-medium text-[#F89525] opacity-0 transition-all duration-500 group-hover:opacity-100">
                    Learn more
                    <span className="transition-transform duration-300 group-hover:translate-x-1">
                      &rarr;
                    </span>
...
function MarqueeBand() {
  return (
    <section className="overflow-hidden border-y border-[#3D3E3D]/10 bg-[#FAF7F2] py-6">
        ...
        {[...Array(3)].map((_, setIdx) => (
          <div key={setIdx} className="architect-marquee-track flex shrink-0">
            {config.marqueeWords.map((word, i) => (
              <span
                key={`${setIdx}-${i}`}
                className="mx-8 text-[clamp(1rem,2vw,1.5rem)] font-medium uppercase tracking-[0.15em] text-[#3D3E3D]/15"
                style={{ fontFamily: "'Rethink Sans', sans-serif" }}
              >
                {word}
                <span className="ml-8 text-[#F89525]/30">/</span>
              </span>
            ))}
          </div>
        ))}
      ...
      <div className="relative flex h-full items-center justify-center">
        <Reveal>
          <p
            ...
            style={{ fontFamily: "'Rethink Sans', sans-serif" }}
          >
            Every structure tells a story.<br />
            <span className="text-[#F89525]">We make yours unforgettable.</span>
          </p>
        </Reveal>
      </div>
    </section>
...
function ProcessSection() {
  ...
  return (
    <section
      ref={sectionRef}
      id="process"
      className="bg-[#FAF7F2] px-6 py-28 lg:px-12 lg:py-36"
    >
      <div className="mx-auto max-w-7xl">
        <Reveal>
          <p className="mb-3 flex items-center gap-3 text-sm font-medium uppercase tracking-[0.2em] text-[#F89525]">
        ...
        <Reveal delay={0.08}>
          <h2
            className="mb-20 max-w-xl text-[clamp(2rem,4vw,3rem)] font-bold leading-tight tracking-tight text-[#1a1a1a]"
            style={{ fontFamily: "'Rethink Sans', sans-serif" }}
          >
        ...
        <div className="relative">
          ...
          <div className="absolute left-0 right-0 top-6 hidden h-[2px] bg-[#3D3E3D]/10 lg:block" />
          {/* Animated fill line (desktop) */}
          <motion.div
            className="absolute left-0 top-6 hidden h-[2px] bg-[#F89525] lg:block"
            style={{ width: lineWidth }}
          />
          {/* Connecting line (mobile) */}
          <div className="absolute bottom-0 left-6 top-0 w-[2px] bg-[#3D3E3D]/10 lg:hidden" />
            ...
            {config.process.map((step, i) => (
              <Reveal key={step.step} delay={i * 0.12}>
                <div className="group relative flex gap-6 lg:flex-col lg:gap-4">
                  {/* Step circle */}
                  <div className="relative z-10 flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-[#F89525] text-lg font-bold text-white shadow-lg shadow-[#F89525]/20 transition-transform duration-300 group-hover:scale-110">
                    {step.step}
                  </div>
                  <div>
                    <h3
                    ...
                    <p className="text-sm leading-relaxed text-[#3D3E3D]/60">
                      {step.description}
                    </p>
                  </div>
                </div>
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl">
        ...
        <Reveal delay={0.08}>
          <h2
            className="mb-16 max-w-lg text-[clamp(2rem,4vw,3rem)] font-bold leading-tight tracking-tight text-[#1a1a1a]"
            style={{ fontFamily: "'Rethink Sans', sans-serif" }}
          >
            Trusted by those who build differently
          </h2>
        </Reveal>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {config.reviews.featured.map((review, i) => (
            <Reveal key={review.author} delay={i * 0.1}>
              <div className="group rounded-2xl border border-[#3D3E3D]/5 bg-white p-8 shadow-sm transition-all duration-500 hover:-translate-y-1 hover:shadow-xl hover:shadow-black/5">
                {/* Stars */}
                <div className="mb-5 flex gap-1">
                  {Array.from({ length: review.rating }, (_, j) => (
                    <svg
                      key={j}
                      className="h-5 w-5 text-[#FBB81B]"
                      fill="currentColor"
                      viewBox="0 0 20 20"
                    >
                ...
                {/* Quote */}
                <p className="mb-6 text-sm leading-relaxed text-[#3D3E3D]/70">
                  &ldquo;{review.text}&rdquo;
                </p>

                {/* Author */}
                <div className="flex items-center gap-3">
                  <div className="flex h-9 w-9 items-center justify-center rounded-full bg-[#F89525]/10 text-sm font-bold text-[#F89525]" style={{ fontFamily: "'Rethink Sans', sans-serif" }}>
...
function FinalCTASection() {
  return (
    <section
      ...
      style={{
        background:
          "linear-gradient(135deg, #F89525 0%, #FBB81B 50%, #F89525 100%)",
      }}
    >
      ...
      <div className="relative mx-auto max-w-3xl text-center">
        ...
        <Reveal delay={0.24}>
          <a
            ...
            className="group inline-flex items-center gap-2 rounded-full bg-white px-10 py-4 text-sm font-bold text-[#3D3E3D] transition-all duration-300 hover:bg-[#1a1a1a] hover:text-white hover:shadow-xl hover:-translate-y-0.5"
            style={{ fontFamily: "'Rethink Sans', sans-serif" }}
          >
...
export default function HomePage() {
  useBrandMeta("architect", config.companyName);
  return (
    <div data-brand="architect" className="min-h-screen bg-[#FAF7F2]">
      <Nav />
      <Hero />
      <StatsBar />
      <AboutStatement />
