...
export default function WhyAxis() {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative bg-[#1B2A4A] py-20 md:py-28 overflow-hidden"
    >
          ...
          <div className="space-y-4">
            {whyAxis.items.map((item, i) => (
              <motion.div
                ...
                className="group relative bg-[#1B2A4A]/80 backdrop-blur-sm border border-[#243656] rounded-sm p-6 pl-8 hover:border-[#D4A843]/30 transition-all duration-300"
              >
                {/* Yellow left accent */}
                <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-[#D4A843]/20 group-hover:bg-[#D4A843] transition-colors duration-300 rounded-l-sm" />

                <div className="flex items-start gap-5">
                  <div className="text-[#D4A843] shrink-0 mt-0.5 group-hover:scale-110 transition-transform duration-300">
