...
export default function ClientLogos() {
  ...
  return (
    <section ref={ref} className="bg-[#1B2A4A] py-16 md:py-20 border-t border-[#243656]">
      ...
      <div className="relative">
        {/* Edge fade masks */}
        <div className="absolute left-0 top-0 bottom-0 w-24 bg-gradient-to-r from-[#1B2A4A] to-transparent z-10 pointer-events-none" />
        <div className="absolute right-0 top-0 bottom-0 w-24 bg-gradient-to-l from-[#1B2A4A] to-transparent z-10 pointer-events-none" />
