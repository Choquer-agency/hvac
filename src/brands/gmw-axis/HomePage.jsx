...
function ServicesSection() {
  ...
  return (
    <section id="services" className="bg-[#1B2A4A] py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-6">
        {/* Header */}
        <FadeInView>
          <p
            className="text-xs font-semibold uppercase tracking-[0.2em] text-[#B8912E] mb-3"
            ...
            return (
              ...
              >
                <motion.div
                  ...
                  className={`group relative overflow-hidden rounded-sm cursor-pointer h-full bg-[#243656] ${
                ...
                >
                  ...
                  <div className="absolute left-0 top-0 bottom-0 w-[3px] bg-[#D4A843] scale-y-0 group-hover:scale-y-100 transition-transform duration-500 origin-bottom z-10" />
                  {/* Content */}
...
function ProcessSection() {
  ...
  return (
    <section id="process" className="bg-[#1B2A4A] py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-6">
        {/* Section header */}
        <FadeInView className="mb-14">
          <p
            className="text-xs font-semibold uppercase tracking-[0.2em] text-[#D4A843] mb-3"
            style={{ fontFamily: "'Space Grotesk', sans-serif" }}
          >
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div className="relative pl-14 sm:pl-16">
            {/* Background line */}
            <div className="absolute left-[19px] sm:left-[23px] top-0 bottom-0 w-[2px] bg-[#243656]" />
            {/* Active progress line */}
            <motion.div
              className="absolute left-[19px] sm:left-[23px] top-0 w-[2px] bg-[#D4A843] origin-top"
                    ...
                    >
                      ...
                      <div
                        className={`absolute -left-14 sm:-left-16 top-4 w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center text-sm font-bold transition-all duration-500 z-10 ${
                          isActive
                            ? "bg-[#D4A843] text-[#1B2A4A] scale-110"
                            : "bg-[#243656] text-gray-500 hover:bg-[#222]"
                        }`}
                        style={{ fontFamily: "'Space Grotesk', sans-serif" }}
                      >
            ...
            <FadeInView delay={0.4} className="mt-8">
              <a
                href="/contact"
                className="inline-block px-8 py-3.5 bg-[#D4A843] text-[#1B2A4A] font-bold text-sm uppercase tracking-wider rounded-full hover:bg-[#B8912E] hover:scale-[1.03] active:scale-[0.98] transition-all duration-200"
                style={{ fontFamily: "'Space Grotesk', sans-serif" }}
              >
          ...
          <FadeInView direction="right" className="sticky top-28">
            <div className="relative overflow-hidden rounded-sm h-[350px] sm:h-[420px] lg:h-[500px] bg-[#243656]">
                ...
                {process.map((_, i) => (
                  <div
                    ...
                    className={`h-1 rounded-full transition-all duration-500 ${
                      i === activeStep ? "w-8 bg-[#D4A843]" : "w-3 bg-white/30"
                    }`}
                  />
                ))}
              </div>
...
function ProjectShowcase() {
  ...
  return (
    <section id="projects" className="bg-[#1B2A4A] py-20 md:py-28">
      <div className="max-w-7xl mx-auto px-6">
        <FadeInView>
          <p
            className="text-xs font-semibold uppercase tracking-[0.2em] text-[#D4A843] mb-3"
          ...
          {projects.map((project, i) => (
            <FadeInView key={project.name} delay={i * 0.1} direction={i % 2 === 0 ? "left" : "right"}>
              <motion.div
                whileHover={{ y: -6 }}
                transition={{ duration: 0.3 }}
                className="group relative overflow-hidden rounded-sm cursor-pointer bg-[#243656]"
              >
                <img
                  src={project.image}
                  loading="lazy"
                ...
                />
                {/* Hover overlay */}
                <div className="absolute inset-0 bg-[#1B2A4A]/0 group-hover:bg-[#1B2A4A]/70 transition-all duration-500 flex flex-col justify-end p-8">
                  <div className="translate-y-6 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                    <div className="w-10 h-[2px] bg-[#D4A843] mb-4" />
                    <h3
                ...
                <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-[#1B2A4A]/80 to-transparent sm:hidden flex flex-col justify-end p-6">
                  <div className="w-8 h-[2px] bg-[#D4A843] mb-3" />
                  <h3
...
function ReviewsSection() {
  ...
  return (
    <section id="reviews" className="bg-[#1B2A4A] py-20 md:py-28 border-t border-[#243656]">
      <div className="max-w-7xl mx-auto px-6">
        <FadeInView>
          <p
            className="text-xs font-semibold uppercase tracking-[0.2em] text-[#D4A843] mb-3"
          ...
          <h2
            ...
            style={{ fontFamily: "'Space Grotesk', sans-serif" }}
          >
            What Our Clients Say About GMW
          </h2>
        </FadeInView>
          ...
          {reviews.featured.map((review, i) => (
            <FadeInView key={review.name} delay={i * 0.12}>
              <motion.div
                ...
                className="group bg-[#1B2A4A] border border-[#243656] hover:border-[#D4A843]/20 rounded-sm p-8 h-full flex flex-col transition-colors duration-300"
              >
                {/* Stars */}
...
function FinalCTASection() {
  ...
  return (
    <section id="cta" className="bg-[#D4A843]">
      <div className="max-w-7xl mx-auto px-6 py-20 md:py-28">
        <FadeInView>
          <div className="max-w-3xl mx-auto text-center">
            <h2
              className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#1B2A4A] uppercase leading-tight mb-6"
              style={{ fontFamily: "'Space Grotesk', sans-serif" }}
            >
              {finalCTA.headline}
            </h2>
            <p
              className="text-[#1B2A4A]/70 text-base sm:text-lg leading-relaxed mb-10 max-w-2xl mx-auto"
              style={{ fontFamily: "'DM Sans', sans-serif" }}
            >
              {finalCTA.body}
            </p>
            <div className="flex flex-wrap justify-center gap-4">
              <a
                ...
                className="px-10 py-4 bg-[#1B2A4A] text-white font-bold text-sm uppercase tracking-wider rounded-full hover:bg-[#243656] hover:scale-[1.03] active:scale-[0.98] transition-all duration-200"
                style={{ fontFamily: "'Space Grotesk', sans-serif" }}
              >
              ...
              <a
                ...
                className="px-10 py-4 border-2 border-[#1B2A4A] text-[#1B2A4A] font-bold text-sm uppercase tracking-wider rounded-full hover:bg-[#1B2A4A] hover:text-white transition-all duration-200"
                style={{ fontFamily: "'Space Grotesk', sans-serif" }}
              >
    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 z-40 lg:hidden bg-[#1B2A4A]/95 backdrop-blur-md border-t border-[#243656] px-6 py-3"
        >
          <a
            href="/contact"
            className="block w-full text-center px-6 py-3 bg-[#D4A843] text-[#1B2A4A] font-bold text-sm uppercase tracking-wider rounded-full hover:bg-[#B8912E] transition-colors"
            style={{ fontFamily: "'Space Grotesk', sans-serif" }}
          >
            Book Now
          </a>
...
function CertBanner() {
  ...
  return (
    <section className="bg-[#243656] border-y border-[#D4A843]/20 py-5 overflow-hidden">
      <div
        className="flex gap-14 items-center"
        style={{
          animation: "certScrollAxis 28s linear infinite",
          width: "max-content",
        }}
      >
        {track.map((badge, i) => (
          <img
            ...
            src={badge.src}
            alt={badge.alt}
            className="h-10 md:h-12 w-auto object-contain opacity-60 hover:opacity-90 transition-opacity duration-300 flex-shrink-0"
            style={{ filter: "brightness(0) invert(1)" }}
          />
        ))}
      </div>
      <style>{`
        @keyframes certScrollAxis {
...
export default function HomePage() {
  useBrandMeta("gmw-axis", config.companyName);
  return (
    <div data-brand="gmw-axis" className="min-h-screen bg-[#1B2A4A]">
      <Nav />
      <Hero />
      <CertBanner />
      <ServicesSection />
      <InlineCTA text="Ready to book your inspection?" buttonLabel="Book Now" />
      <WhyAxis />
      <ProcessSection />
      <ParallaxDivider />
      <ProjectShowcase />
